                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nom" type="text" class="form-control @error('nom') is-invalid @enderror" value="{{ old('nom') }}" required autocomplete="nom">
                                @error('nom')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adr" type="text" class="form-control" value="{{ old('adr') }}" required>
                            </div>
                        </div>
                        ...
                        <div id="datenaissance" class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dn" type="date" class="form-control" value="{{ old('dn') }}">
                            </div>
                        </div>
                        ...
                        <div id="cab" class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cabinet" type="text" class="form-control" value="{{ old('cabinet') }}">
                            </div>
                        </div>
